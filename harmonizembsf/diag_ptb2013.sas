/******************************************************************************************************************************************
	...
	Program: diag_ptb2013 (from diag_ptb2012)

	Description: Extracts and compiles ICD-9 info from Medicare files 

	Extracts from Part B claims only for 2013
  ...
  October 2015, p.stclair: made this version to pull extracts for 2012
  December 2014, p.stclair: made this version to pull extracts for 2013
...
%resetnseg(ip,2002,2013)
%resetnseg(op,2002,2013)
%resetnseg(snf,2002,2013)
%resetnseg(hha,2002,2013)
%resetnseg(hos,2002,2013)
%resetnseg(car,2002,2013)
%resetnseg(med,2002,2013)
%resetnseg(dme,2002,2013)
...
%extprocs1(car,&linedx   ,
           ...
           smp=l,clms=,begy=2013,endy=2013);
