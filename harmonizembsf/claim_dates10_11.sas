...
%resetnseg(ip,2010,2011)
%resetnseg(op,2010,2011)
%resetnseg(snf,2010,2011)
%resetnseg(hha,2010,2011)
%resetnseg(hos,2010,2011)
%resetnseg(car,2010,2011)
%resetnseg(dme,2010,2011)
...
/********************************************************************/
/** Extract dates from 2010-2011 claim files with standard varnames */
...
%procs0210(ip,,,asisnames=&commonstd &staystd &ipsnfstd &wklystd,
           idvar=bene_id,claimvar=clm_id,begy=2010,endy=2011,
           smp=c,clms=);
