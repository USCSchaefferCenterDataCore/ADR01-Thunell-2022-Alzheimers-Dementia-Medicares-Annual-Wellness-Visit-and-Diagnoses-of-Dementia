/******************************************************************************************************************************************
	...
	Program: diag_ptb2012 (from diag_ptb10_11)

	Description: Extracts and compiles ICD-9 info from Medicare files 

	Extracts from Part B claims only for 2012
...
%extprocs1(car,&linedx   ,
           ...
           smp=l,clms=,begy=2012,endy=2012);
