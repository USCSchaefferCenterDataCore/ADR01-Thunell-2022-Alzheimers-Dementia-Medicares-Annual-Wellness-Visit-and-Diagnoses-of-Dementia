/* hcpcs_outp12_13.sas
   ...
   JUST 2012-2013, JUST OP, DME, CAR.
   ...
   February 2016, p.st.clair. Modified for 2012 and 2013.
...
%let maxyr=2013; /* current default is 2012 */
%partABlib;   
