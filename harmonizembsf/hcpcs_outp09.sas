...
%extprocs1(op,&ophha_apc,&op_apcstd,
           ...
           smp=r,clms=,begy=2009,endy=2009);

%extprocs1(dme,&linedx,&linedxstd,
           asisnames=&bcommonstd hcpcs_cd mdfr_cd: &linedtstd &linevardme,
           idvar=bene_id,claimvar=clm_id,RLvar=line_num,typsfx=L,
           smp=l,clms=,begy=2009,endy=2009);

%extprocs1(car,&linedx,&linedxstd,
           asisnames=&bcommonstd hcpcs_cd mdfr_cd: &linedtstd &linevarstd,
           idvar=bene_id,claimvar=clm_id,RLvar=line_num,typsfx=L,
           smp=l,clms=,begy=2009,endy=2009);
