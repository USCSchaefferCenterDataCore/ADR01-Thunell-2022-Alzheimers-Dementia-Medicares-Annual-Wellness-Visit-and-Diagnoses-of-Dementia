/* bene_status_year.sas
  ...
  October 30, 2014, p. st.clair: generalized for transition to DUA 25731
	...
	September 13, 2019, pferido: added 2015 & 2016;
	
*/

options ls=150 ps=58 nocenter compress=yes replace mprint merror;

%include "../../setup.inc";
%include "&maclib.sascontents.mac";
%include "&maclib.listvars.mac";
%include "&maclib.renvars.mac";
%include "statyr_2015on.mac";  /* macro to get bene_status_year vars across years */
