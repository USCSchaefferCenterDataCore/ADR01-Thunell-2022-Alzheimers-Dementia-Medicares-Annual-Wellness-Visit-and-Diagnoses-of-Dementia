/* claim_dates09.sas
   ...
   Oct. 27, 2014: split 2006-2008 and 2009 extract program into two programs.
   August 2014, p.ferido: modified to use single claim files for DME, adjusted for DUA-51866
...
/* 2009 has same variables as 2006-2008 but slightly different file name format
    fname=[typ]c2009 */    

%procs0210(ip,,,asisnames=&commonstd &staystd &ipsnfstd &wklystd,
           idvar=bene_id,claimvar=clm_id,begy=2009,endy=2009,
           smp=c,clms=);
